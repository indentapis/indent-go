...
func (m *GroupVersionKind) MarshalLogObject(oe zapcore.ObjectEncoder) error {
	...
	keyName = "Group" // field group = 1
	oe.AddString(keyName, m.Group)

	keyName = "Version" // field version = 2
	oe.AddString(keyName, m.Version)

	keyName = "Kind" // field kind = 3
...
func (m *Capabilities) MarshalLogObject(oe zapcore.ObjectEncoder) error {
	...
	keyName = "Capabilities" // field capabilities = 9
	oe.AddArray(keyName, zapcore.ArrayMarshalerFunc(func(ae zapcore.ArrayEncoder) error {
...
func (m *GetIntegrationRequest) MarshalLogObject(oe zapcore.ObjectEncoder) error {
	...
	keyName = "IntegrationName" // field integrationName = 9
...
func (m *Install) MarshalLogObject(oe zapcore.ObjectEncoder) error {
	...
	keyName = "Integration" // field integration = 5
	...
	oe.AddString(keyName, m.Status.String())
